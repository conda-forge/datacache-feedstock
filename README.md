...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/datacache-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/datacache-feedstock)
...
Once the `conda-forge` channel has been enabled, `datacache` can be installed with:

```
conda install datacache
```

It is possible to list all of the versions of `datacache` available on your platform with:
